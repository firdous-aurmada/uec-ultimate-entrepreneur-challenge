...
export const FIGHTERS = [
  {
    id: 'ava', name: 'AVA STERLING', title: 'THE VISIONARY', company: 'NIMBUS LABS',
    tagline: 'Sees the future. Bills for it quarterly.',
    special: 'pitchdeck',
  ...
  {
    id: 'max', name: 'MAX VEGA', title: 'THE BURNER', company: 'ROCKETLY',
    tagline: 'Spends $2 to make $1. Confidently.',
    special: 'burnrate',
  ...
  {
    id: 'kai', name: 'KAI NAKAMURA', title: 'THE PIVOT', company: 'LOOPWISE',
    tagline: 'It’s not a crisis, it’s a pivot.',
    special: 'pivot',
  ...
  {
    id: 'zara', name: 'ZARA OKAFOR', title: 'THE GROWTH HACKER', company: 'HYPERVINE',
    tagline: 'Up and to the right. Always.',
    special: 'growthhack',
  ...
  {
    id: 'eleanor', name: 'ELEANOR VOSS', title: 'THE SHARK', company: 'APEX CAPITAL',
    tagline: 'Term sheets. Teeth. In that order.',
  ...
  {
    id: 'dex', name: 'DEX KRUGER', title: 'THE RAIDER', company: 'OMNICORP HOLDINGS',
    tagline: 'Your company? Adorable. It’s mine now.',
    special: 'takeover',
